...
def result():
    ...
    new_game = Game()
    result = new_game.two_player_game(player_1, player_2)
    return render_template('results_page.html', player_1_name=player_1_name, player_1_choice=player_1_choice, player_2_name=player_2_name, player_2_choice=player_2_choice, result=result)
